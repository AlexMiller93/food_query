...
class FoodsAPIListView(generics.ListAPIView):
    """ Список разделов меню, в которых есть хотя бы одно блюдо и
        у которых `is_publish=True`"""
    ...
    def get_queryset(self):
        ...
        # список первичных ключей по ключу 'категория' с разделами меню
        # из запроса active_foods
